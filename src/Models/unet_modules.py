...
class decoderUNet(pl.LightningModule):
    def __init__(self, config):
        ...
        # Decoder part
        self.up_1 = up_conv_2d(self.channel_list[-1], # 512
                               self.channel_list[-1], 
                               **kwargs['upconv'])
